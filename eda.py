...
# Load data
df = pd.read_csv("data/processed/crisis_train.csv")
...
plt.tight_layout()
plt.savefig('reports/figures/fig2_text_length.png', dpi=150)
plt.close()
...
stopwords.update(['will', 'one', 'now', 'just', 'like', 
...
plt.tight_layout()
plt.savefig('reports/figures/fig3_wordcloud_crisis.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('reports/figures/fig4_wordcloud_non_crisis.png', dpi=150)
plt.close()


# FIGURE 5: Counsel Chat Topic Distribution
# check columns names
df2 = pd.read_csv("data/processed/counsel_chat_clean.csv")
...
plt.tight_layout()
plt.savefig('reports/figures/fig5_counsel_topics.png', dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig('reports/figures/fig6_answer_length.png', dpi=150)
plt.close()
...
with open("data/external/knowledge_base.json", "r") as f:
    kb = json.load(f)
...
plt.tight_layout()
plt.savefig('reports/figures/fig7_knowledge_base.png', dpi=150)
plt.close()